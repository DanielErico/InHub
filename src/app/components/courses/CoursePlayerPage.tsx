            ...
            <div className="p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-5">
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground text-sm">AI-powered notes generated specifically for your lesson</p>
                </div>
              ...
              {!notesContent && !isGeneratingNotes && !notesError && (
                <div className="bg-card rounded-2xl border border-dashed border-border p-12 text-center">
                  ...
                  <p className="text-muted-foreground/80 text-sm max-w-xs mx-auto">
                    Click the button above to generate smart, structured notes from this lesson using advanced AI.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-4">
              ...
              <div className="bg-blue-100 border border-blue-200 rounded-xl px-4 py-3 flex items-center gap-2.5">
                ...
                <p className="text-blue-900 text-xs">
                  <strong>AI Tutor</strong> — Powered by AI · Context: {course.title}
                </p>
              </div>
