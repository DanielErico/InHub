...
const pageTitles: Record<string, string> = {
  ...
  "/app/tutor/content": "Manage Courses",
  "/app/tutor/students": "My Students",
  "/app/tutor/schedule": "Schedule",
  "/app/tutor/settings": "Settings",
};

const mobileNavItems = [
  { to: "/app/tutor/dashboard", icon: LayoutDashboard, label: "Home" },
  { to: "/app/tutor/content", icon: FolderUp, label: "Courses" },
  { to: "/app/tutor/students", icon: Users, label: "Students" },
